...
<div class="content-wrapper arcadia-main-container ">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>View Item Wise Last Issued Unit Price</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Item Wise Last Issued Unit Price</a></li>
                        <li class="breadcrumb-item active">View Item Wise Last Issued Unit Price</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script src="<?php echo base_url('resources/pageJS/itemWiseLastIssuedUnitPrice.js') ?>"></script>